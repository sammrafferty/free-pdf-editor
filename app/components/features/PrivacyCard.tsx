...
export default function PrivacyCard() {
  return (
    ...
    >
      ...
      {/* Right — SVG illustration (static: locked state) */}
      <div style={{ flexShrink: 0 }}>
        ...
        >
          ...
          <circle cx="110" cy="96" r="78" stroke="var(--text-muted)" strokeWidth="1" strokeDasharray="5 4" fill="none" opacity="0.35" />
          <text x="110" y="188" textAnchor="middle" fontSize="9" fill="var(--text-muted)" fontFamily="system-ui, sans-serif" opacity="0.5">Your Browser</text>
          ...
          <ellipse cx="110" cy="105" rx="36" ry="30" fill="#4ade80" opacity="0.18" filter="url(#privacy2-blur)" />
          <defs>
          ...
          {/* Lock body (green glow) */}
          <rect
            x="82" y="102" width="56" height="50" rx="8"
            fill="var(--bg-tertiary, var(--bg-secondary))"
            stroke="#4ade80" strokeWidth="2"
            style={{ filter: "drop-shadow(0 0 8px #4ade80) drop-shadow(0 0 3px #4ade80)" }}
          />

          {/* Shackle (closed position) */}
          <g style={{ transform: "translateY(0px)", transformOrigin: "110px 104px" }}>
            <path d="M94 104 L94 82 Q110 64 126 82 L126 104" fill="none" stroke="var(--text-muted)" strokeWidth="2.5" strokeLinecap="round" />
          </g>

          {/* Checkmark (visible — locked state) */}
          <path
